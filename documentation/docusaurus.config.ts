...
const config: Config = {
  ...
  url: process.env.ENV_SiteUrl ? process.env.ENV_SiteUrl : 'http://localhost:3000',
  baseUrl: process.env.ENV_BaseUrl ? process.env.ENV_BaseUrl : '/',
      ...
      items: [
        {
          ...
          position: 'right',
          html: `
              <a style="display:flex" href="https://github.com/" target="_blank" rel="noreferrer noopener" aria-label="Components playground">
